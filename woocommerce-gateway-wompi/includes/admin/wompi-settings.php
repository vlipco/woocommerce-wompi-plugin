...
return apply_filters(
	...
	array(
		...
		'webhook' => array(
			...
			'type'        => 'title',
			'description' => sprintf( __( 'You must add the following webhook endpoint <strong style="background-color:#ddd;">&nbsp;%s&nbsp;</strong> to your <a href="https://comercios.wompi.co/my-account" target="_blank">Wompi account settings</a>.', 'woocommerce-gateway-wompi' ), add_query_arg( 'wc-api', 'wc_wompi', trailingslashit( get_home_url() ) ) ),
		),
		'testmode' => array(
